...
public class MillerGrindTrigger extends SimpleCriterionTrigger<MillerGrindTrigger.TriggerInstance> {
    ...
    public static Criterion<TriggerInstance> criterion() {
        return new Criterion<>(ModTriggers.MILLER_GRIND.get(), new TriggerInstance());
    }
}