...
public class PressResidueTrigger extends SimpleCriterionTrigger<PressResidueTrigger.TriggerInstance> {
    ...
    public static void trigger(ServerPlayer player) {
        ModTriggers.PRESS_RESIDUE.get().trigger(player, instance -> true);
    }
    ...
    public static Criterion<TriggerInstance> criterion() {
        return new Criterion<>(ModTriggers.PRESS_RESIDUE.get(), new TriggerInstance());
    }
}